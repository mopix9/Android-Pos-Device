 ...
 */
public abstract class Hilt_BuyFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BuyFragment_GeneratedInjector) this.generatedComponent()).injectBuyFragment(UnsafeCasts.<BuyFragment>unsafeCast(this));
    }
  }
