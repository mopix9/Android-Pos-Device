 ...
 */
public abstract class Hilt_PrintReceiptFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PrintReceiptFragment_GeneratedInjector) this.generatedComponent()).injectPrintReceiptFragment(UnsafeCasts.<PrintReceiptFragment>unsafeCast(this));
    }
  }
