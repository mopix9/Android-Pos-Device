 ...
 */
public abstract class Hilt_FailFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FailFragment_GeneratedInjector) this.generatedComponent()).injectFailFragment(UnsafeCasts.<FailFragment>unsafeCast(this));
    }
  }
