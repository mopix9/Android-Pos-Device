 ...
 */
public abstract class Hilt_ChargeFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ChargeFragment_GeneratedInjector) this.generatedComponent()).injectChargeFragment(UnsafeCasts.<ChargeFragment>unsafeCast(this));
    }
  }
