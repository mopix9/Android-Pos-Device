 ...
 */
public abstract class Hilt_SettlementFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SettlementFragment_GeneratedInjector) this.generatedComponent()).injectSettlementFragment(UnsafeCasts.<SettlementFragment>unsafeCast(this));
    }
  }
