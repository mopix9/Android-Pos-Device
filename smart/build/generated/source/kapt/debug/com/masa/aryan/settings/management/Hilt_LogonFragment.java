 ...
 */
public abstract class Hilt_LogonFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LogonFragment_GeneratedInjector) this.generatedComponent()).injectLogonFragment(UnsafeCasts.<LogonFragment>unsafeCast(this));
    }
  }
