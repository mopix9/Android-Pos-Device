 ...
 */
public abstract class Hilt_ManagementFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ManagementFragment_GeneratedInjector) this.generatedComponent()).injectManagementFragment(UnsafeCasts.<ManagementFragment>unsafeCast(this));
    }
  }
