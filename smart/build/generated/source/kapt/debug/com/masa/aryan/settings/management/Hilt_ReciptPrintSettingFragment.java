 ...
 */
public abstract class Hilt_ReciptPrintSettingFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ReciptPrintSettingFragment_GeneratedInjector) this.generatedComponent()).injectReciptPrintSettingFragment(UnsafeCasts.<ReciptPrintSettingFragment>unsafeCast(this));
    }
  }
