 ...
 */
public abstract class Hilt_TransactionListFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TransactionListFragment_GeneratedInjector) this.generatedComponent()).injectTransactionListFragment(UnsafeCasts.<TransactionListFragment>unsafeCast(this));
    }
  }
