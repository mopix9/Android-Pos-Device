 ...
 */
public abstract class Hilt_BillSuccessFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BillSuccessFragment_GeneratedInjector) this.generatedComponent()).injectBillSuccessFragment(UnsafeCasts.<BillSuccessFragment>unsafeCast(this));
    }
  }
