 ...
 */
public abstract class Hilt_BuySuccessFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BuySuccessFragment_GeneratedInjector) this.generatedComponent()).injectBuySuccessFragment(UnsafeCasts.<BuySuccessFragment>unsafeCast(this));
    }
  }
