 ...
 */
public abstract class Hilt_BalanceFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BalanceFragment_GeneratedInjector) this.generatedComponent()).injectBalanceFragment(UnsafeCasts.<BalanceFragment>unsafeCast(this));
    }
  }
