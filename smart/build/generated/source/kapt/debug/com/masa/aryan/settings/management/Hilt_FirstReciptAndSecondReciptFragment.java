 ...
 */
public abstract class Hilt_FirstReciptAndSecondReciptFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FirstReciptAndSecondReciptFragment_GeneratedInjector) this.generatedComponent()).injectFirstReciptAndSecondReciptFragment(UnsafeCasts.<FirstReciptAndSecondReciptFragment>unsafeCast(this));
    }
  }
