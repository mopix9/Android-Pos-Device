 ...
 */
public abstract class Hilt_SearchTransactionFragment extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SearchTransactionFragment_GeneratedInjector) this.generatedComponent()).injectSearchTransactionFragment(UnsafeCasts.<SearchTransactionFragment>unsafeCast(this));
    }
  }
