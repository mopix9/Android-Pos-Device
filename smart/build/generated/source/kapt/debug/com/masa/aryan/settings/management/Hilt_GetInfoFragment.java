 ...
 */
public abstract class Hilt_GetInfoFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((GetInfoFragment_GeneratedInjector) this.generatedComponent()).injectGetInfoFragment(UnsafeCasts.<GetInfoFragment>unsafeCast(this));
    }
  }
