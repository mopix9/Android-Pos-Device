 ...
 */
public abstract class Hilt_ShowReceiptFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ShowReceiptFragment_GeneratedInjector) this.generatedComponent()).injectShowReceiptFragment(UnsafeCasts.<ShowReceiptFragment>unsafeCast(this));
    }
  }
