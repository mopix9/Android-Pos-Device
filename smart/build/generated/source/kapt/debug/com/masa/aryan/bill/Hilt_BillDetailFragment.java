 ...
 */
public abstract class Hilt_BillDetailFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BillDetailFragment_GeneratedInjector) this.generatedComponent()).injectBillDetailFragment(UnsafeCasts.<BillDetailFragment>unsafeCast(this));
    }
  }
