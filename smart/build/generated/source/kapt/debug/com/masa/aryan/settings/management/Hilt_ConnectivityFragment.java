 ...
 */
public abstract class Hilt_ConnectivityFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ConnectivityFragment_GeneratedInjector) this.generatedComponent()).injectConnectivityFragment(UnsafeCasts.<ConnectivityFragment>unsafeCast(this));
    }
  }
