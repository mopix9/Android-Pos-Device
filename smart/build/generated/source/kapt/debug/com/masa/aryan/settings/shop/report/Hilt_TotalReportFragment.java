 ...
 */
public abstract class Hilt_TotalReportFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TotalReportFragment_GeneratedInjector) this.generatedComponent()).injectTotalReportFragment(UnsafeCasts.<TotalReportFragment>unsafeCast(this));
    }
  }
