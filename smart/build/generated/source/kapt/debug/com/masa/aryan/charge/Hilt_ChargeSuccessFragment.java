 ...
 */
public abstract class Hilt_ChargeSuccessFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ChargeSuccessFragment_GeneratedInjector) this.generatedComponent()).injectChargeSuccessFragment(UnsafeCasts.<ChargeSuccessFragment>unsafeCast(this));
    }
  }
