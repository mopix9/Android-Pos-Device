 ...
 */
public abstract class Hilt_PasswordFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PasswordFragment_GeneratedInjector) this.generatedComponent()).injectPasswordFragment(UnsafeCasts.<PasswordFragment>unsafeCast(this));
    }
  }
