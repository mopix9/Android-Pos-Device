 ...
 */
public abstract class Hilt_TerminalFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TerminalFragment_GeneratedInjector) this.generatedComponent()).injectTerminalFragment(UnsafeCasts.<TerminalFragment>unsafeCast(this));
    }
  }
