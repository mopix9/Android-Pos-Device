 ...
 */
public abstract class Hilt_BalanceSuccessFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BalanceSuccessFragment_GeneratedInjector) this.generatedComponent()).injectBalanceSuccessFragment(UnsafeCasts.<BalanceSuccessFragment>unsafeCast(this));
    }
  }
