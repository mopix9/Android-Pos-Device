 ...
 */
public abstract class Hilt_SwipeFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SwipeFragment_GeneratedInjector) this.generatedComponent()).injectSwipeFragment(UnsafeCasts.<SwipeFragment>unsafeCast(this));
    }
  }
