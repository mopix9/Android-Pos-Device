...
class ManagementFragment : BaseFragment<FragmentManagementBinding>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.connectionSettings.setOnClickListener{
            navigate(this,R.id.action_managementFragment_to_connectivityFragment)
        }

        binding.configuration.setOnClickListener {
            navigate(this,R.id.action_managementFragment_to_configurationFragment)
        }

        binding.terminalSettings.setOnClickListener {
            navigate(this,R.id.action_managementFragment_to_terminalFragment)
        }

        binding.resetPassword.setOnClickListener{
            navigate(this,R.id.action_managementFragment_to_merchantPasswordFragment)
        }
        binding.reciptPrintSettingFragment.setOnClickListener {
            navigate(this,R.id.action_managementFragment_to_selectReciptTypeToPrintFragment)
        }
        ...
        binding.back.setOnClickListener {
            navigate(this,R.id.action_managementFragment_to_settingsFragment)
        }
