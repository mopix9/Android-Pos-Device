...
class SearchReceiptFragment : BaseFragment<FragmentSearchReceiptBinding>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.searchByRrn.setOnClickListener {
            navigate(this,R.id.action_searchReceiptFragment_to_searchTransactionFragment,bundleOf("TYPE" to 1))
        }

        binding.searchByStan.setOnClickListener {
            navigate(this,R.id.action_searchReceiptFragment_to_searchTransactionFragment,bundleOf("TYPE" to 0))
