...
import com.masa.aryan.databinding.FragmentPrintReceiptBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.lastReceipt.setOnClickListener {
            lifecycleScope.launch {
                ...
                if (transaction != null) {
                    navigate(this@PrintReceiptFragment,R.id.action_printReceiptFragment_to_showReceiptFragment, bundleOf("ID" to transaction.id))
                } else {
        ...
        binding.searchReceipt.setOnClickListener {
            navigate(this,R.id.action_printReceiptFragment_to_searchReceiptFragment)
        }
