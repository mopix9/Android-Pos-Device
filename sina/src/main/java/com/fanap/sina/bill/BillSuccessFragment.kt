...
import com.fanap.sina.databinding.FragmentBillSuccessBinding
...
class BillSuccessFragment : BaseFragment<FragmentBillSuccessBinding>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        onTimerFinish.observe(viewLifecycleOwner,{navigate(this,R.id.action_billSuccessFragment_to_swipeFragment) })
        binding.cancel.setOnClickListener { navigate(this,R.id.action_billSuccessFragment_to_swipeFragment) }
        binding.back.setOnClickListener { navigate(this,R.id.action_billSuccessFragment_to_swipeFragment) }
