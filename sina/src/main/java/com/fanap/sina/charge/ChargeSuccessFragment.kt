...
import com.fanap.sina.databinding.FragmentChargeSuccessBinding
...
class ChargeSuccessFragment :BaseFragment<FragmentChargeSuccessBinding>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        onTimerFinish.observe(viewLifecycleOwner,{ navigate(this,R.id.action_chargeSuccessFragment_to_swipeFragment) })
        binding.cancel.setOnClickListener { navigate(this,R.id.action_chargeSuccessFragment_to_swipeFragment) }
        binding.back.setOnClickListener { navigate(this,R.id.action_chargeSuccessFragment_to_swipeFragment) }
