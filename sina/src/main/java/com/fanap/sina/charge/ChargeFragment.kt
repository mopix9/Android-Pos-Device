...
import com.fanap.sina.databinding.FragmentChargeBinding
...
class ChargeFragment : BaseFragment<FragmentChargeBinding>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        onTimerFinish.observe(viewLifecycleOwner,{
            navigate(this,R.id.action_chargeFragment_to_swipeFragment)
        })
        ...
        binding.edtPhone.setOnTouchListener { _, _ ->
            binding.keyboard.setInputConnection(binding.edtPhone.onCreateInputConnection(EditorInfo()))
            false
        }

        binding.back.setOnClickListener { navigate(this,R.id.action_chargeFragment_to_swipeFragment) }
        binding.cancel.setOnClickListener { navigate(this,R.id.action_chargeFragment_to_swipeFragment) }
    ...
    private fun showAmountBottomSheet(isChargeCode: Boolean) {
       ...
       navigate(this,R.id.action_chargeFragment_to_chargeAmountFragment,bundle)
    }
            ...
            withContext(Dispatchers.Main) {
                if (result != null) {
                    ...
                    if (responseCode == "00") {
                        ...
                        viewModel.updateTransaction(transaction)
                        val printResult = prepareReceiptPrint(result)
                        if (printResult){
                        ...
                        viewModel.updateTransaction(transaction)
                        prepareReceiptPrint(result)
                        navigate(this@ChargeFragment, R.id.action_chargeFragment_to_buyFailFragment,
            ...
            withContext(Dispatchers.Main) {
                if (result != null) {
                    ...
                    if (SinaUtils.isSuccessfulResponseForConfirmAndReverse(responseCode)) {
                        ...
                        navigate(this@ChargeFragment, R.id.action_chargeFragment_to_chargeSuccessFragment,
                        ...
                        if (adviceRepeatCount < 5)
                            ...
                            viewModel.updateTransaction(adviceTransaction)
                            navigate(
                                this@ChargeFragment, R.id.action_chargeFragment_to_chargeSuccessFragment,
    ...
    private suspend fun prepareReceiptPrint(result: HashMap<IsoFields,String>?) : Boolean {
        ...
        return lifecycleScope.async(Dispatchers.IO) {
            if (result != null) {
                ...
                if (responseCode == "00") {
                    ...
                    DeviceSDKManager.getPrinterInterface(requireContext())?.printBitmap(receipt) ?: false
                } else {
                    val data = viewModel.makeReceipt(track2, result)
