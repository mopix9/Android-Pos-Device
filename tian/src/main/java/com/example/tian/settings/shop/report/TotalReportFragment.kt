...
import com.example.tian.settings.shop.report.viewmodel.TotalReportViewModel
import com.exmple.tian.databinding.FragmentTotalReportBinding
...
@AndroidEntryPoint
class TotalReportFragment : BaseFragment<FragmentTotalReportBinding>() , TimePickerDialog.OnTimeSetListener, DatePickerDialog.OnDateSetListener {
    ...
    override fun getViewBinding(
        ...
        container: ViewGroup?
    ) = FragmentTotalReportBinding.inflate(inflater,container,false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnPrintReceipt.setOnClickListener {
            ...
            } else Utils.makeSnack(binding.root, "لطفا تاریخ شروع و پایان را انتخاب کنید!", Snackbar.LENGTH_SHORT).show()
        }
    }
