...
import com.example.tian.settings.shop.viewmodel.CodeRequestViewModel
import com.exmple.tian.R
import com.exmple.tian.databinding.FragmentShiftBinding
...
// how to show the ui to user if user is enable what see and if is disable what to show
        lifecycleScope.launch {
            ...
            try {
                if (userRepository.getEnabledUser(true)!!.userId == sharedpref.getString(
                        EDIT_PREF_TEXT, "")!!
                        .toLong()
                ) {
