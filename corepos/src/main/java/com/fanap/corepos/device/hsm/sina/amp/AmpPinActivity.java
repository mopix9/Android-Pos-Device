...
import com.fanap.corepos.device.hsm.sina.amp.other.AmpConstant;
import com.fanap.corepos.device.hsm.sina.amp.other.ISOUtil;
import com.fanap.corepos.device.hsm.sina.amp.other.StringUtil2;
...
public class AmpPinActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pinResult = AmpHSMSina.provideListener();
    ...
    private void showPinKeyBoard() {
        ...
        parentView = (ViewGroup) LayoutInflater.from(this).inflate(R.layout.pinkeyboardlayout, null);
