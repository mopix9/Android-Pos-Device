...
import com.fanap.corepos.device.hsm.sayan.amp.AmpPinActivity;
import com.fanap.corepos.device.hsm.sayan.amp.other.PinInfo;
import com.fanap.corepos.device.hsm.sayan.amp.other.PinpadListener;
import com.fanap.corepos.device.hsm.sayan.amp.other.PinpadManager;
...
public class AmpHSMSayan implements HSMInterface, AmpPinActivity.PinResult {
    ...
    String TAG = "AmpHSMSayan";
    private static AmpHSMSayan ampHSM;
    ...
    public byte[] calcMac(byte[] macData) {
        return pinpadProvider.getMac(KeySystem.MS_DES, macKeyIndex, MACMode.MAC_MODE_EMV, convertToEightMod(macData));
        /*if (mac != null)
