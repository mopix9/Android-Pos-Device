package com.fanap.corepos.device.hsm.util.smartpeak;
...
public class GlobalData {
    ...
    public void init(Context context) {
        ...
        mContext = context;
        mPrefs = mContext.getApplicationContext().getSharedPreferences(PREFERENCES, Context.MODE_PRIVATE);
        mEditor = mPrefs.edit();
    }
