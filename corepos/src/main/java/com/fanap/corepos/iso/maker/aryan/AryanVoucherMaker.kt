...
class AryanVoucherMaker : Maker() {
    ...
    override fun makeIso(msg: HashMap<IsoFields, String>): IsoMsg {
        ...
        iso.apply {
            ...
            setField(48,msg[IsoFields.Serial]+ "~" +msg[IsoFields.SoftwareVersion]+ "~" +msg[IsoFields.TerminalLanguageCode]+ "~" +msg[IsoFields.ChargeOrganization]+ "~" +msg[IsoFields.ConnectionType] )
