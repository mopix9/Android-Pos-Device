...
class SayanVoucherUnPacker  : UnPacker() {
    ...
    override fun unpack(): HashMap<IsoFields, String> {
        ...
        msg[IsoFields.ChargeSerial] = getFieldWithTagName(msg[IsoFields.Buffer1],"ESC")
        msg[IsoFields.ChargePin] = getFieldWithTagName(msg[IsoFields.Buffer1],"EPC")
        msg[IsoFields.ChargeRealAmount] = getFieldWithTagName(msg[IsoFields.Buffer1],"ERA")
