...
class AryanBuyUnPacker  : UnPacker() {
    ...
    override fun unpack(): HashMap<IsoFields, String> {
        ...
        msg[IsoFields.IssuerMessage] = Encoding.convertToWindows1256(IsoUtil.hexStringToByteArray(getFieldWithTagName(msg[IsoFields.Buffer1],"37")))
