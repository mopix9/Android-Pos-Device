...
class AryanTopupUnPacker  : UnPacker() {
    ...
    override fun unpack(): HashMap<IsoFields, String> {
        ...
        msg[IsoFields.BankName] = Encoding.convertToWindows1256(IsoUtil.hexStringToByteArray(getFieldWithTagName(msg[IsoFields.Buffer1],"38"))).split("-")[0]
        msg[IsoFields.ChargeSerial] = Encoding.convertToWindows1256(IsoUtil.hexStringToByteArray(getFieldWithTagName(msg[IsoFields.Buffer1],"40")))
        msg[IsoFields.ChargePin] = Encoding.convertToWindows1256(IsoUtil.hexStringToByteArray(getFieldWithTagName(msg[IsoFields.Buffer1],"41")))
        ...
        msg[IsoFields.ChargeOrganization] = Encoding.convertToWindows1256(IsoUtil.hexStringToByteArray(getFieldWithTagName(msg[IsoFields.Buffer1],"51")))
