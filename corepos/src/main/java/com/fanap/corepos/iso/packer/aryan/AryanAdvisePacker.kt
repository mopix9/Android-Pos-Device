...
class AryanAdvisePacker  : Packer() {
...
//            TODO SMARTPEAK
            /*val mac = ServiceManager.getInstence().pinpad.calcMACByArea(40, 50, tempByteList.toByteArray().sliceArray
                (5 until tempByteList.size).toString(), BwPinpadSource.MAC_MOD919).toByteArray()*/
//   INUSE FOR NEWLAND & SMARTPEAK
